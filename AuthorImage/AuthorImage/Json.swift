  ...
  "artists": [
    {
      ...
      "works": [
        ...
        },
        {
          ...
          "image": "Picasso3",
          "info": "1913–14, L'Homme aux cartes (Card Player), oil on canvas, 108 × 89.5 cm, Museum of Modern Art, New York"
        },
        {
          "title": "Asleep",
          "image": "Picasso4",
          "info": "The model of this painting, Asleeep, painted in 1932, is Picasso's mistress Marie Therese. She was resting between the two powerful polarized color blocks of red and green, which accentuate the tranquility of Marie Therese while sleeping. The solid black outline around the Marie's hands and profile is a feature of the series recalling the Fauvist's black binding of color blocks.(PabloPicasso.org)"
        }
      ]
    },
    {
      ...
      "works": [
        {
          ...
          "image": "Georgia1",
          "info": "Flowers fascinated Georgia and they were her favorite subject on canvas. She seems to have liked particular flowers - the calla lily, poppy, canna, iris, petunia, and jimson weed. O'Keeffe painted Oriental Poppies in 1928. This stunning work was declared a groundbreaking, art masterpiece. (georgiaokeeffe.net)"
        },
        {
          "title": "Jimson Weed, White Flower No. 1",
          "image": "Georgia2",
          "info": "Jimson Weed is an oil on linen painting by American artist Georgia O'Keeffe from 1936, located in the Indianapolis Museum of Art, which is in Indianapolis, Indiana, USA. It depicts four large blossoms of jimson weed, or datura."
        },
        {
          "title": "Sky Above Clouds IV",
          "image": "Georgia3",
          "info": "Among the most dramatic and well-known images of O'Keeffe's later years are her cloudscapes of the 1960s and '70s. Traveling around the world, she was exhilarated by the views seen from an airplane window. She described the changing patterns and colors as 'breathtaking' and was moved to interpret these sights and feelings in paint. "
        },
        {
          "title": "Radiator Building — Night, New York",
          "image": "Georgia4",
          "info": "This painting illustrates O'Keeffe's skill in articulating architectural structures as well as her use of the highly realistic, yet simplified style of Precisionism. She uses the night backdrop to incorporate a play between structure and light, and between the straight lines of the architectural forms and the ethereal smoke, which is reminiscent of the folds of flowers. O'Keeffe's portrait of the Radiator Building, an Art Deco skyscraper that was completed just three years prior to the painting, presents an iconic image that captures the changing skyline of New York City that O'Keeffe often found claustrophobic. (theartstory.org)"
        }
      ]
    },
    {
      "name": "Andy Warhol",
      "bio": "Andy Warhol (August 6, 1928 – February 22, 1987), born Andrew Warhola, was an American artist who was a leading figure in the visual art movement known as pop art.",
      "image": "4",
      "works": [
        {
          "title": "Marilyn Diptych",
          "image": "Andy1",
          "info": "The Marilyn Diptych (1962) is a silkscreen painting by American pop artist Andy Warhol. The piece is one of the artist's most famous works, and it has been praised by several cultural critics such as Camille Paglia and others. The original piece is currently owned by the Tate. Noticed qualities in the painting is how the top right panel has faded , this was done to show Marylin's more mortal and realistic features ."
        },
        {
          "title": "Campbell’s Soup Cans",
          "image": "Andy2",
          "info": "Campbell's Soup Cans, which is sometimes referred to as 32 Campbell's Soup Cans, is a work of art produced in 1962 by Andy Warhol. It consists of thirty-two canvases, each measuring 20 inches (51 cm) in height × 16 inches (41 cm) in width and each consisting of a painting of a Campbell's Soup can—one of each of the canned soup varieties the company offered at the time."
        },
        {
          "title": "Eight Elvises",
          "image": "Andy3",
          "info": "Eight Elvises is a 1963 silkscreen painting by American pop artist Andy Warhol. In 2008 it was sold for $100 million to a private buyer, making the painting the most valuable work by Andy Warhol at the time. The current owner and location of the painting, which has not been seen publicly since the 1960s, are unknown."
        },
        {
          "title": "Self-Portrait",
          "image": "Andy4",
          "info": "Comprising solely of a flat, vibrant fiery-red silkscreen image of Warhol emblazoned like a single and dramatic paint-splash over the black void of the canvas, this vast, nearly three-metre-square Self-Portrait is an imposing, haunting and ultimately poignant work from Warhol's great last series of self-portraits made in 1986. (wikiart.org)"
        }
      ]
    },
    {
      "name": "Leonardo da Vinci",
      "bio": "Leonardo di ser Piero da Vinci, more commonly Leonardo da Vinci (15 April 1452 – 2 May 1519), was an Italian polymath whose areas of interest included invention, painting, sculpting, architecture, science, music, mathematics, engineering, literature, anatomy, geology, astronomy, botany, writing, history, and cartography. He has been variously called the father of paleontology, ichnology, and architecture, and is widely considered one of the greatest painters of all time.",
      "image": "5",
      "works": [
        {
          "title": "Mona Lisa",
          "image": "Leonardo1",
          "info": "The Mona Lisa is a half-length portrait of a woman by the Italian artist Leonardo da Vinci, which has been acclaimed as 'the best known, the most visited, the most written about, the most sung about, the most parodied work of art in the world'"
        },
        {
          "title": "The Last Supper",
          "image": "Leonardo2",
          "info": "The Last Supper is a late 15th-century mural painting by Leonardo da Vinci in the refectory of the Convent of Santa Maria delle Grazie, Milan. It is one of the world's most famous paintings."
        },
        {
          "title": "Lady with an Ermine",
          "image": "Leonardo3",
          "info": "Lady with an Ermine is a painting by Leonardo da Vinci from around 1489–1490. The subject of the portrait is Cecilia Gallerani, and painted at a time when she was the mistress of Ludovico Sforza, Duke of Milan, and Leonardo was in the service of the Duke. The painting is one of only four portraits of women painted by Leonardo, the others being the Mona Lisa, the portrait of Ginevra de' Benci, and La belle ferronnière."
        },
        {
          "title": "The Battle of Anghiari",
          "image": "Leonardo4",
          "info": "The Battle of Anghiari (1505) is a lost painting by Leonardo da Vinci, at times referred to as 'The Lost Leonardo', which some commentators believe to be still hidden beneath one of the later frescoes in the Salone dei Cinquecento (Hall of the Five Hundred) in the Palazzo Vecchio, Florence. Its central scene depicted four men riding raging war horses engaged in a battle for possession of a standard, at the Battle of Anghiari in 1440."
        }
      ]
    },
    {
...
// Define your Artist and Artworks structs
...
func loadArtists() -> [Artist] {
    ...
    if let data = JSON.data(using: .utf8) {
        do {
            let artists = try decoder.decode([String: [Artist]].self, from: data)
...
//
//do {
//    let jsonObject = try JSONDecoder().decode([String: [Artist]].self, from: jsonString)
//    print(jsonObject["artists"]?[0].name ?? "")
//} catch {
